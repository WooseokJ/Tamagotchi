...
struct TamaInfo {
    ...
    let TamaAttribute: [Tama] = [
        Tama(name: "따끔따끔 다마고치", imageName : "1-6"),
        Tama(name: "방실방실 다마고치", imageName : "2-6"),
        Tama(name: "반짝빤짝 다마고치", imageName: "3-6"),
        Tama(name: "준비중이에요", imageName: "noImage"),
        Tama(name: "준비중이에요", imageName: "noImage"),
        Tama(name: "준비중이에요", imageName: "noImage"),
        Tama(name: "준비중이에요", imageName: "noImage"),
        Tama(name: "준비중이에요", imageName: "noImage"),
...
//        }
        ...
        Tama(name: "따끔따끔 다마고치", imageName : "1-5"),
        Tama(name: "따끔따끔 다마고치", imageName : "1-6"),
        ...
        Tama(name: "방실방실 다마고치", imageName : "2-4"),
        Tama(name: "방실방실 다마고치", imageName : "2-5"),
        Tama(name: "방실방실 다마고치", imageName : "2-6"),
        ...
        Tama(name: "반짝빤짝 다마고치", imageName: "3-4"),
        Tama(name: "반짝빤짝 다마고치", imageName: "3-5"),
        Tama(name: "반짝빤짝 다마고치", imageName: "3-6"),
        Tama(name: "반짝빤짝 다마고치", imageName: "3-7"),
        Tama(name: "반짝빤짝 다마고치", imageName: "3-8"),
